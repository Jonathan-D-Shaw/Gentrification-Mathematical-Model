%3-variable, spatial ring system simulation (Euler's method)
function [a_mat, n_mat, c_mat] = Euler3VarSpatialRingSim(n,A,N,C,params)
...
c_mat(1,:) = C; 
    ...
    for i = 1:(length(params.t)-1)
        ...
        %derivative calcs: 
        Adot = 1/params.tau_a * ((params.R.*f_C')*A - A.*((params.R.*f_C)*params.un)) + 0*rand(n,1);
